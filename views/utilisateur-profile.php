        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body bg-dark">
                    <a href="http://localhost/movies-system/gestion-utilisateurs" class="btn btn-outline-light mb-2"><i class="fa fa-home"></i></a>
                    <a href="http://localhost/movies-system/utilisateur-change-password" class="btn btn-light mb-2">Change Password</i></a>
                    <form method="post">
