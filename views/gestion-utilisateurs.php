            ...
            <?php if ($_SESSION['user']->role === 'Administrateur') { ?>
                <div class="card">
                    <div class="card-body bg-dark">
                        <a href="http://localhost/movies-system/utilisateur-create" title="Ajoute employé" class="btn btn-light mb-2"><i class="fa fa-plus"></i></a>
                                    ...
                                    <?php foreach ($users as $user) { ?>
                                        <tr>
                                            ...
                                            <td class="d-flex flex-row">
                                                <form class="ml-2" method="post" action="utilisateur-delete">
